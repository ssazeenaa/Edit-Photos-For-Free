self.Module = {
    wasmBinaryFile: 'https://cdn.jsdelivr.net/gh/ssazeenaa/Batch-PNG-Compressor/image_compressor.wasm',
    print: log,
    printErr: logError
};

importScripts('https://cdn.jsdelivr.net/gh/ssazeenaa/Batch-PNG-Compressor/image_compressor.js');
